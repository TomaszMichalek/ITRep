...
import pl.michalek.kontenery.dao.UserDAO;
...
public class MyUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(final String login) 
		...
		pl.michalek.kontenery.domain.User user = userDAO.findByLogin(login);
	...
	private User buildUserForAuthentication(pl.michalek.kontenery.domain.User user, 
